...
public class HelpCommand implements CommandExecutor
{
    ...
    public CommandResult execute(CommandSource source, CommandContext context) throws CommandException {
        Map<List<String>, CommandSpec> commands = Commands.PCCommands;
        List<Text> helpList = Lists.newArrayList();
        Map<List<String>, CommandSpec> trainercommands = Commands.Subcommands;
        ...
        for (List<String> aliases : commands.keySet()) {
            ...
            for (List<String> aliases : commands.keySet()) {
                CommandSpec commandSpec = commands.get(aliases);
                Text commandHelpTrainer = Text.builder()
                        .append(Text.builder()
                        ...
                        .append(Text.builder()
                                ...
                                .build())
                        .append(Text.builder()
                                .append(Text.of(TextColors.GRAY, "Usage: /trainer " + aliases.toString().replace("[", "").replace("]", " " + commandSpec.getUsage(source).toPlain())))
                                .build())
                        .build();
                helpList.add(commandHelpTrainer);
